...
@Component
public class OctreeBuilderWithInternalScheduler implements OctreeBuilderInterface {

    Logger logger = LoggerFactory.getLogger(OctreeBuilderWithInternalScheduler.class);
    ...
    public OctreeBuilderWithInternalScheduler(LasToolsService lasToolsService, SystemFileStorageService systemFileStorageService, OctreeProperties octreeProperties) {
